...
public class SafariHandler extends SourceHandler {
    ...
    public void actionPerformed(ActionEvent event){
        ...
        System.out.println(filesNotSaved);
    }
    ...
    private String getURLSFromSafari(){
        ...
        // TODO: Solve: Program execution can be faster than copying links via Applescript
        // there is no safe delay, need to synchronize somehow applescript execution with program.
        Main.waitMs(2000);
    ...
    private void runAppleScript(String script) {
        ...
        try {
            ...
            //System.out.println("copying time: " end-start);
        } catch (IOException e) {
            e.printStackTrace();
            ableToExecute = false;
        }
